# -*- coding: utf-8 -*-
"""
Created on Fri Mar 22 12:28:52 2024
...
def append_historical_data():
    try:
        ...
        dax_data = tv.get_hist("DE30EUR", 'OANDA', interval=Interval.in_30_minute, n_bars=500)
        ...
        print("Historical data appended successfully 30 min.",datetime.now())
        #return True
    ...
    while True:
        try:
            with excel_lock:
                ...
                if new_minute.minute // 30 != current_minute.minute // 30:
