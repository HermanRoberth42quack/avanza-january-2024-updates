# -*- coding: utf-8 -*-
"""
Created on Fri Jan 26 15:56:11 2024
...
class TvDatafeedLive(maintv.TvDatafeed):
    """                 
    ...
    def new_seis(self, symbol, exchange, interval, timeout=-1): 
        ...
        new_seis=maintv.Seis(symbol, exchange, interval)
    ...
    def new_consumer(self, seis, callback, timeout=-1):
        ...
        consumer=maintv.Consumer(seis, callback)
        if self._lock.acquire(timeout=timeout) is False:
            return False
    ...
    def get_hist(self,  
        symbol = "DE30EUR",
        exchange = "OANDA",
        interval: maintv.Interval = maintv.Interval.in_daily,
        n_bars: int = 10,
