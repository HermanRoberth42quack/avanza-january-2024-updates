# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 15:48:11 2024
...
def append_historical_data():
    try:
        ...
        dax_data = tv.get_hist("DE30EUR", 'OANDA', interval=Interval.in_5_minute, n_bars=500)
        ...
        print("Historical data appended successfully 5min.",datetime.now())
        #return True
    ...
    while True:
        try:
            with excel_lock:
                ...
                if new_minute.minute // 5 != current_minute.minute // 5:
